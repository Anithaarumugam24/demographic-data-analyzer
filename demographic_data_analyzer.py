...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = round(df[df['sex'] == 'Male']['age'].mean(), 1)p

    # 3. Percentage with Bachelorsp
